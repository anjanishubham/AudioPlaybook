package com.example.audioplayer.media.service
...
import com.example.audioplayer.media.exoplayer.MediaPlayerNotificationManager
...
class MediaPlayerService:MediaBrowserServiceCompat() {
    ...
    private fun preparePlayer(
        ...
        exoPlayer.setMediaSource(
            mediaSource
                .getMediaSource(dataSourceFactory)
        )
        exoPlayer.prepare()
